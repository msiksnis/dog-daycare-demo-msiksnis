  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "text-muted-foreground rounded-md w-10 md:w-12 font-normal",
        ...
        day: cn(
          ...
          "h-10 w-10 md:h-12 md:w-12 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 ",
        ),
